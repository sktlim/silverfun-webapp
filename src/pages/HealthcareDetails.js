      ...
      <div className="h-min">
        ...
        <div className="h-min flex justify-center">
          ...
          <div class="py-10 mx-10 w-1/2 h-min">
            ...
            <div className="flex flex-col justify-center items-center mt-16 h-1/2 border-2 bg-white px-5 w-full rounded-lg drop-shadow-lg shadow shadow-gray-500/40 py-10">
              <img
